...
public class SavedFlowerListGui implements InventoryProvider {
    ...
    public static void openGui(Player player, List<SavedFlowerPot> pots) {
        SmartInventory.builder()
                ...
                .title(CraftFlowers.arrow + Messages.GUI.SAVED_FLOWERPOTS)
                .build().open(player);
    ...
    public void init(Player player, InventoryContents contents) {
        ...
        for (int i = 0; i < flowerPots.size(); i++) {
            ...
            itemMeta.setDisplayName(CraftFlowers.prefix + Messages.GUI.SAVED_FLOWERPOTS_NAME_COLOR + savedFlowerPot.getName());
