...
public class LanguageFile {
    ...
    public static String getActionMissingFollowingItemsList(String arror, String flower, Integer integer) {
        ACTION_MISSING_FOLLOWING_ITEMS_LIST = ACTION_MISSING_FOLLOWING_ITEMS_LIST.replaceAll("%1", arror);
        ACTION_MISSING_FOLLOWING_ITEMS_LIST = ACTION_MISSING_FOLLOWING_ITEMS_LIST.replaceAll("%2", flower);
        ACTION_MISSING_FOLLOWING_ITEMS_LIST = ACTION_MISSING_FOLLOWING_ITEMS_LIST.replaceAll("%3", String.valueOf(integer));
