...
public class FlowerRegistry {
    ...
    static {
        ...
        registerFlower(new Flower(Material.CHORUS_PLANT, "§2Chorus Plant"));
        registerFlower(new Flower(Material.CHORUS_FLOWER, "§2Chorus Flower"));
        registerFlower(new Flower(Material.CHAIN, "§2Chain"));
